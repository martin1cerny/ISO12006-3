...
{
	/// <summary>
    /// Readonly interface for xtdProperty
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IxtdProperty : IxtdObject
	{
...
namespace Xbim.ISO_12006_3_V3
{
	...
	{
		#region IxtdProperty explicit implementation
		 
		#endregion

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal xtdProperty(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
        ...
        public bool Equals(@xtdProperty other)
	    {
	        return this == other;
	    }
        #endregion
