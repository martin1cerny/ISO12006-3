...
namespace Xbim.ISO_12006_3_V4
{
	...
	{ 
        ...
        public xtdInteger(long val)
        {
            _value = val;
        }

		public xtdInteger(string val)
        {
			_value = System.Convert.ToInt64(val);
        }

        public static implicit operator xtdInteger(long value)
        {
            return new xtdInteger(value);
        }

        public static implicit operator long(xtdInteger obj)
        {
            return obj._value;
        ...
        public override bool Equals(object obj)
        {
            ...
            return ((xtdInteger) obj)._value == _value;
        }
        ...
        public static bool operator ==(xtdInteger obj1, xtdInteger obj2)
        {
