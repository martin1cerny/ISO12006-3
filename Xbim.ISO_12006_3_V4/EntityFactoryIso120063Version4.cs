	...
	public sealed class EntityFactoryIso120063Version4 : IEntityFactory
	{
		...
		public IInstantiableEntity New(IModel model, int typeId, int entityLabel, bool activated)
		{
			...
			switch(typeId)
			{
				...
				case 6: return new xtdRelAssignsPropertyWithConstraint ( model, entityLabel, activated );
				case 15: return new xtdDerivedUnit ( model, entityLabel, activated );
				case 16: return new xtdDerivedUnitElement ( model, entityLabel, activated );
				case 17: return new xtdMonetaryUnit ( model, entityLabel, activated );
				case 19: return new xtdContextDependentUnit ( model, entityLabel, activated );
				case 20: return new xtdConversionBasedUnit ( model, entityLabel, activated );
				case 21: return new xtdConversionBasedUnitWithOffset ( model, entityLabel, activated );
				case 22: return new xtdSIUnit ( model, entityLabel, activated );
				case 27: return new xtdDimensionalExponents ( model, entityLabel, activated );
				case 30: return new xtdUnit ( model, entityLabel, activated );
				case 31: return new xtdValue ( model, entityLabel, activated );
				case 38: return new xtdActivity ( model, entityLabel, activated );
				case 39: return new xtdActor ( model, entityLabel, activated );
				case 40: return new xtdBag ( model, entityLabel, activated );
				case 42: return new xtdDescription ( model, entityLabel, activated );
				case 43: return new xtdExternalDocument ( model, entityLabel, activated );
				case 44: return new xtdLanguage ( model, entityLabel, activated );
				case 46: return new xtdMeasureWithUnit ( model, entityLabel, activated );
				case 47: return new xtdName ( model, entityLabel, activated );
				case 48: return new xtdNest ( model, entityLabel, activated );
				case 50: return new xtdProperty ( model, entityLabel, activated );
				case 51: return new xtdRelActsUpon ( model, entityLabel, activated );
				case 52: return new xtdRelAssignsCollections ( model, entityLabel, activated );
				case 53: return new xtdRelAssignsMeasures ( model, entityLabel, activated );
				case 54: return new xtdRelAssignsProperties ( model, entityLabel, activated );
				case 55: return new xtdRelAssignsPropertyWithValues ( model, entityLabel, activated );
				case 56: return new xtdRelAssignsUnits ( model, entityLabel, activated );
				case 57: return new xtdRelAssignsValues ( model, entityLabel, activated );
				case 58: return new xtdRelAssociates ( model, entityLabel, activated );
				case 60: return new xtdRelCollects ( model, entityLabel, activated );
				case 61: return new xtdRelComposes ( model, entityLabel, activated );
				case 62: return new xtdRelDocuments ( model, entityLabel, activated );
				case 63: return new xtdRelGroups ( model, entityLabel, activated );
				case 64: return new xtdRelSequences ( model, entityLabel, activated );
				case 65: return new xtdRelSpecializes ( model, entityLabel, activated );
				case 67: return new xtdSubject ( model, entityLabel, activated );
				default:
					return null;
			}
		}
