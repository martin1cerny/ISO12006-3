...
{
	/// <summary>
    /// Readonly interface for xtdBag
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IxtdBag : IxtdCollection
	{
...
namespace Xbim.ISO_12006_3_V4
{
	...
	{
		#region IxtdBag explicit implementation
		 
		#endregion

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal xtdBag(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
        ...
        public bool Equals(@xtdBag other)
	    {
	        return this == other;
	    }
        #endregion
