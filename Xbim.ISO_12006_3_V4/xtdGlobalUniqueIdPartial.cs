...
{
    public partial struct xtdGlobalUniqueID
    {
        /// <summary>
        ...
        public static implicit operator Guid(xtdGlobalUniqueID gid)
        {
            return ConvertFromBase64(gid._value);
        }

        public static implicit operator xtdGlobalUniqueID(Guid gid)
        {
