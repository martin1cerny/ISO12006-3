...
{
	/// <summary>
    /// Readonly interface for xtdActor
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IxtdActor : IxtdObject
	{
...
namespace Xbim.ISO_12006_3_V4
{
	...
	{
		#region IxtdActor explicit implementation
		 
		#endregion

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal xtdActor(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
        ...
        public bool Equals(@xtdActor other)
	    {
	        return this == other;
	    }
        #endregion
